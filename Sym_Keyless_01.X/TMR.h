...
#define TMR0PollingTime 5 //mS 
#define TMR0PollingTimeToFeq    (1000uL/TMR0PollingTime)
#define Timer0PS    TMR0Rate256
#define Timer0Rate  (Timer0PS+1)
#define FillTMR0    (256-156)
...
extern void Run_TMR1(uint16_t count,uint8_t EN);
extern void Run_TMR2(uint8_t count,uint8_t EN);
